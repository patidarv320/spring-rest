...
public class CustomTokenAuthenticationProcessingFilter extends AbstractAuthenticationProcessingFilter{

	private static Logger LOGGER = Logger.getLogger(CustomTokenAuthenticationProcessingFilter.class);
	
	private final AuthenticationFailureHandler failureHandler;
    private final TokenExtractor tokenExtractor;
    
    @Autowired
    public CustomTokenAuthenticationProcessingFilter(AuthenticationFailureHandler failureHandler, 
